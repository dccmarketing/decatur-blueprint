...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="header-wrap">
			...
			<nav id="dowork-navigation" class="dowork-navigation" role="navigation">
				<button class="menu-toggle"><?php _e( 'Do Work', 'decatur-blueprint' ); ?></button><?php

				get_template_part( 'menu', 'dowork' );
	...
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle"><?php _e( 'Menu', 'decatur-blueprint' ); ?></button><?php
